  ...
  return (
    <>
      <form className={styles.form} onSubmit={onSubmit}>
        <InputEmail ref={emailInputRef} className={`${styles.input} ${invalidCredentialsClassName}`} placeholder="E-mail" name="email" value={email} onChange={onChangeEmail}  required={true} />
        <InputPassword className={`${styles.input} ${invalidCredentialsClassName}`} placeholder="Senha" name="password" value={password} onChange={onChangePassword}  required={true} />
